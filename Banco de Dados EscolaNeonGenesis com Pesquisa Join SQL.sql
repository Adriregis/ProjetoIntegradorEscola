...
INSERT INTO professor (nome, email) VALUES ("RENATA SILVA", 'renata.lopes@example.com');
...
INSERT INTO materia (nome, id_aluno, id_professor) VALUES ("GEOGRAFIA", 4, 4);
...
INSERT INTO avaliacao (id_materia, nota, peso) VALUES (4, 8, 2);
...
FROM 
    aluno
JOIN 
    materia ON aluno.id = materia.id_aluno
JOIN 
    avaliacao ON materia.id = avaliacao.id_materia
JOIN 
    professor ON materia.id_professor = professor.id
GROUP BY 
    aluno.nome, aluno.data_nascimento, professor.nome, professor.email, materia.nome;